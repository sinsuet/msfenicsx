...
def _policy_snapshot(phase: str) -> PolicySnapshot:
    return PolicySnapshot(
        phase=phase,
        allowed_operator_ids=("native_sbx_pm", "local_refine", "radiator_expand"),
        ...
        candidate_annotations={
            ...
            "radiator_expand": {"operator_family": "speculative_custom"},
        },
    )
...
def test_prefeasible_prompt_projection_omits_post_feasible_frontier_fields() -> None:
    ...
    payload = prompt_projection.build_prompt_projection(
        ...
        original_candidate_operator_ids=("native_sbx_pm", "local_refine", "radiator_expand"),
...
def test_post_feasible_prompt_projection_keeps_frontier_and_regression_fields() -> None:
    ...
    assert payload["operator_summary"]["radiator_expand"]["post_feasible_avg_objective_delta"] == pytest.approx(-0.34)
