...
def test_initialize_experiment_directories_creates_expected_single_mode_structure(tmp_path) -> None:
    experiment_root = tmp_path / "panel-four-component-hot-cold-benchmark" / "experiments" / "nsga2_raw__0401_1430"
...
def test_build_experiment_manifest_includes_mode_template_and_seed_index() -> None:
    manifest = build_experiment_manifest(
        ...
        optimization_spec_path="scenarios/optimization/panel_four_component_hot_cold_nsga2_union_llm_l1.yaml",
    )
