...
**Architecture:** 不手改原始 seed-run 结论，不把旧 artifact 静默删除。保留旧 S4 archive 为 superseded 审计目录，在原 official archive 路径重建新的 5-seed suite。Comparison planner 先规范化 `nsga2_llm:*` 与 `llm:*` 的 method identity，避免来自不同 batch 的 LLM seed 被拆成两个方法。所有论文结果表和叙述只从重建后的 suite-owned `comparisons/` 和 `scenario_runs/paper_experiment_db/` 导出。
...
- Keep `main_s6` pending; do not use S6 feedback-off as main evidence.
...
|---:|---|---|---|
| 11 | `scenario_runs/s4_aggressive10/0510_archive__raw_union_llm-deepseek_v4_flash_5seed/raw/seeds/seed-11` | `.../union/seeds/seed-11` | `.../llm-deepseek-v4-flash/seeds/seed-11` |
...
| 17 | `scenario_runs/s4_aggressive10/0510_archive__raw_union_llm-deepseek_v4_flash_5seed/raw/seeds/seed-17` | `.../union/seeds/seed-17` | `.../llm-deepseek-v4-flash/seeds/seed-17` |
...
| 23 | `scenario_runs/s4_aggressive10/0510_archive__raw_union_llm-deepseek_v4_flash_5seed/raw/seeds/seed-23` | `.../union/seeds/seed-23` | `.../llm-deepseek-v4-flash/seeds/seed-23` |
...
**Files:**
- Rename/source-preserve: `scenario_runs/s4_aggressive10/0510_archive__raw_union_llm-deepseek_v4_flash_5seed`
- Create: `scenario_runs/s4_aggressive10/0510_archive__raw_union_llm-deepseek_v4_flash_5seed`
- Create: `scenario_runs/s4_aggressive10/0510_archive__raw_union_llm-deepseek_v4_flash_5seed/archive_provenance.yaml`
- Refresh: `scenario_runs/s4_aggressive10/0510_archive__raw_union_llm-deepseek_v4_flash_5seed/run_index.csv`
...
**Files:**
- Refresh: `scenario_runs/s4_aggressive10/0510_archive__raw_union_llm-deepseek_v4_flash_5seed/comparisons/`
...
**Files:**
- Modify: `scenario_runs/paper_experiment_db/manifest.yaml`
- Refresh: `scenario_runs/paper_experiment_db/tables/*.csv`
- Refresh: `scenario_runs/paper_experiment_db/msfenicsx_experiments.duckdb`
...
- Modify: `paper/els-cas-templates/planning/*.md`
- Modify: `paper/els-cas-templates/planning/chapter_briefs/*.md`
- Modify: `paper/els-cas-templates/sections/*.tex`
...
- [ ] State S4/S5 aggregate-mean LLM superiority while leaving `main_s6` pending.
- [ ] State S5 seed11 is diagnostic, not multi-seed evidence.
...
- [ ] Verify S4 official archive and paper DB no longer contain active `seed-29` or `seed-31` rows.
...
- [ ] Report generated tables, DuckDB status, nIGD status, claim evidence status, and `main_s6 pending`.
