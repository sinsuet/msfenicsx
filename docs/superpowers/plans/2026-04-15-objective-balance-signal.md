...
**Tech Stack:** Python, pytest, numpy. All work in the `codex/l2-llm-controller-recovery` branch worktree at `./.worktree/codex-l2-llm-controller-recovery`.

**Spec:** `docs/superpowers/specs/2026-04-15-objective-balance-signal-design.md`

**Run prefix:** `conda run -n msfenicsx`

**Working directory:** `./.worktree/codex-l2-llm-controller-recovery`
